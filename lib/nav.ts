...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: 'PiggyBank',
    items: [
      { label: 'Fixed Assets Management', href: '/fixed-assets', status: 'planned' },
      { label: 'Budgeting & Forecasting', href: '/budgeting', status: 'planned' },
      { label: 'Expense Management', href: '/expenses', status: 'planned' },
      { label: 'Tax Management', href: '/tax', status: 'planned' },
    ],
  },
  {
    ...
    icon: 'Boxes',
    items: [
      { label: 'Inventory / Stock', href: '/inventory', status: 'planned' },
      { label: 'Sales Management', href: '/sales-management', status: 'planned' },
      { label: 'Purchase Management', href: '/purchase-management', status: 'planned' },
    ],
  },
  {
    label: 'Payroll & HR',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Point of Sale (POS)', href: '/pos', status: 'planned' },
      { label: 'Multi-Company Management', href: '/multi-company', status: 'planned' },
      { label: 'CRM Integration', href: '/crm', status: 'planned' },
    ],
  },
];
